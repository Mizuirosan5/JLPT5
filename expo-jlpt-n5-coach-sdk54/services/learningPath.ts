...
> = {
  start: {
    ...
    successCriteria: ['18 reponses de diagnostic terminees', 'Rapport consulte', 'Premiers points faibles identifies'],
  ...
  const rawStages: Omit<LearningPathStage, 'status'>[] = [
    {
      ...
      focus: 'Routine',
      progress: clampProgress(activity.attempts, 18),
      done: Math.min(activity.attempts, 18),
      total: 18,
