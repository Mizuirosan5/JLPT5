...
export const styles = StyleSheet.create({
  ...
  vocabularySpecialMenuIcon: {
    color: '#F6C85F',
    fontSize: 34,
    fontWeight: '800',
  },
  vocabularySpecialMenuTitle: {
    color: '#FFFFFF',
    fontSize: 15,
    fontWeight: '800',
  },
  vocabularySpecialMenuText: {
    color: '#C9D4D7',
    fontSize: 12,
    lineHeight: 16,
  },
  vocabularyThemeBackButton: {
    alignItems: 'center',
    backgroundColor: '#FFFFFF',
    borderColor: '#E8D7C4',
    borderRadius: 8,
  ...
  vocabularyThemeBackCopy: {
    flex: 1,
    gap: 2,
  },
  vocabularyThemeBackLabel: {
    color: '#647B83',
    fontSize: 11,
    fontWeight: '700',
  },
  vocabularyThemeBackTitle: {
    color: '#152B3A',
    fontSize: 16,
    fontWeight: '900',
  },
  ...
  genericVocabMnemonicIcon: {
    color: '#C83543',
    fontSize: 15,
    fontWeight: '900',
  },
  genericVocabMnemonicText: {
    color: '#152B3A',
    flex: 1,
    fontSize: 9,
    fontWeight: '700',
